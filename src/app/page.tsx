    ...
    return (
      <div className="min-h-screen bg-[#000000] flex flex-col items-center justify-center relative overflow-hidden">
        <div className="relative z-10 flex flex-col items-center px-6 max-w-[420px] w-full animate-fade-in">
          ...
          <div className="mt-6 flex items-center gap-3 w-full max-w-[320px]">
          ...
          <button
            ...
            className="mt-4 text-[14px] text-[#94a3b8] hover:text-white transition-colors"
          >
            Already have an account? <span className="text-white font-semibold">Sign In</span>
          </button>

          <p className="mt-4 text-[11px] text-[#64748b] text-center leading-relaxed">
    ...
    <div className="min-h-screen bg-[#000000] flex flex-col items-center justify-center relative overflow-hidden">
      <div className="relative z-10 flex flex-col items-center px-6 max-w-[420px] w-full animate-fade-in">
        ...
        <button
          ...
          className="mt-4 text-[14px] text-[#94a3b8] hover:text-white transition-colors"
        >
          New to Black94? <span className="text-white font-semibold">Create Account</span>
        </button>
