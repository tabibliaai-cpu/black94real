  ...
  return (
    <div
      className={cn(
        ...
        viewed
          ? 'bg-white/20'
          : 'bg-gradient-to-tr from-[#a3d977] via-[#2a7fff] to-[#f91880]'
      )}
    >
...
function StoryViewer({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black flex flex-col animate-fade-in">
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-3 z-20 w-9 h-9 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center hover:bg-black/60 transition-colors"
      >
      ...
      <div className="flex-[15] min-h-0 bg-black flex flex-col justify-between px-4 pt-2 pb-3 safe-area-bottom">
        {/* User info */}
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#a3d977] to-[#6ba84a] flex items-center justify-center text-black font-bold text-sm shrink-0 overflow-hidden">
            {group.profileImage ? (
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1">
              ...
              {group.verified && (
                <svg className="w-[14px] h-[14px] text-[#a3d977] shrink-0" viewBox="0 0 22 22" fill="none">
            ...
            <span className="text-[12px] text-[#71767b]">@{group.username}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex-1 h-9 rounded-full bg-white/[0.08] border border-white/[0.1] flex items-center px-3 mr-3">
            <span className="text-[13px] text-[#536471]">Send message</span>
          </div>
  ...
  return (
    <div>
      ...
      <div className="px-4 pt-3 pb-2">
        <h2 className="text-xl font-bold text-[#e8f0dc]">Stories</h2>
        <p className="text-[13px] text-[#71767b] mt-0.5">Tap to view updates from people you follow</p>
      </div>
      ...
      <div className="px-4 pb-4">
        <div className="flex items-center gap-4 overflow-x-auto no-scrollbar pb-1">
          ...
          <button className="flex flex-col items-center gap-1.5 shrink-0">
            ...
            <span className="text-[11px] text-[#71767b]">Your story</span>
          </button>
            ...
            >
              <StoryRing viewed={false} size={64}>
                {g.profileImage ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-[#1a2a1a] to-[#0a0a0a] flex items-center justify-center text-[16px] text-[#a3d977] font-bold">
                    {(g.displayName || 'U')[0]}
                  </div>
                )}
              </StoryRing>
              <span className="text-[11px] text-[#e8f0dc] max-w-[64px] truncate">{g.displayName.split(' ')[0]}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      {viewed.length > 0 && (
        <div className="px-4 pt-4">
          <h3 className="text-[15px] font-bold text-[#71767b] mb-3">Viewed</h3>
              ...
              >
                ...
                <div className="absolute bottom-0 inset-x-0 p-2.5">
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#a3d977] to-[#6ba84a] flex items-center justify-center text-black font-bold text-[10px] shrink-0 overflow-hidden">
                      {g.profileImage ? (
                        <img src={g.profileImage} alt="" className="w-full h-full object-cover" />
                      ) : (
                        (g.displayName || 'U')[0]
                    ...
                    <div className="text-left min-w-0">
                      ...
                      <p className="text-[11px] text-[#71767b] truncate">@{g.username}</p>
                    </div>
                  </div>
                </div>
              </button>
      ...
      <div className="px-4 pt-6 pb-4">
        <h3 className="text-[15px] font-bold text-[#71767b] mb-3">Suggested for you</h3>
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-2.5">
                ...
                <p className="text-[11px] text-[#71767b]">@{s.user}</p>
              </div>
