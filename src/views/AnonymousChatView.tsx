      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-[340px]">
          ...
          <div className="relative mb-6">
            ...
            {started && (
              <div className="absolute -inset-2 rounded-3xl border border-[#FFFFFF]/20 animate-pulse-soft" />
            )}
          </div>
          ...
          {myAlias && (
            <div className="mb-8 inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.04] border border-white/[0.08]">
              ...
              <span className="text-[13px] text-[#FFFFFF] font-mono tracking-wide">{myAlias}</span>
            </div>
          )}
            ...
            <div className="flex flex-col items-center gap-4 w-full animate-fade-in">
              <div className="flex items-center gap-2.5">
                <div className="flex items-center gap-1">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#FFFFFF] animate-bounce" style={{ animationDelay: '0ms' }} />
                  <div className="w-1.5 h-1.5 rounded-full bg-[#FFFFFF] animate-bounce" style={{ animationDelay: '150ms' }} />
                  <div className="w-1.5 h-1.5 rounded-full bg-[#FFFFFF] animate-bounce" style={{ animationDelay: '300ms' }} />
                </div>
        ...
        {isMatching && (
          <div className="flex flex-col items-center justify-center h-full gap-5">
            <div className="w-16 h-16 rounded-2xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-center">
              <MaskIcon className="w-10 h-10 text-[#FFFFFF]/50 animate-pulse-soft" />
            </div>
            <div className="flex items-center gap-1.5">
            ...
            return (
              <div key={msg.id} className={cn('flex flex-col', msg.isMine ? 'items-end' : 'items-start')}>
                <span className={cn(
                  ...
                  msg.isMine ? 'text-[#FFFFFF]/50' : 'text-[#71767b]'
                )}>
        ...
        {selectedImage && (
          <div className="px-3 py-2.5 bg-[#000000] border-t border-white/[0.06]">
            <div className="flex items-center gap-3">
              ...
              <button onClick={handleSendImage} className="w-9 h-9 rounded-full flex items-center justify-center bg-[#FFFFFF] text-black shrink-0 active:scale-90 transition-transform" style={{ minHeight: 0, minWidth: 0 }}>
