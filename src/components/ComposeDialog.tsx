  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full max-w-lg bg-[#0d0b14] border border-white/[0.08] rounded-t-2xl sm:rounded-2xl animate-scale-in max-h-[85vh] flex flex-col">
        ...
        {/* Body */}
        <div className="flex gap-4 p-5 overflow-y-auto flex-1">
          <PAvatar
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="border-t border-white/[0.08] pt-3.5 mt-2.5 flex items-center justify-between">
              ...
              {text.length > maxLen * 0.85 && (
                <span className={cn('text-[13px] tabular-nums', overLimit ? 'text-red-400 font-bold' : 'text-[#94a3b8]')}>
                  {remaining}
                </span>
              )}
            </div>
