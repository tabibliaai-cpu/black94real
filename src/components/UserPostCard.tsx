          ...
          <div className="flex-1 min-w-0" onClick={handleDoubleTap}>
            ...
            <div className="flex items-center gap-1 flex-wrap">
              ...
              {post.authorIsVerified && (
                <svg className="w-[18px] h-[18px] text-[#8b5cf6] shrink-0" viewBox="0 0 22 22" fill="none">
            ...
            {/* Caption */}
            {post.caption && (
              <p className="text-[15px] leading-[22px] text-[#f0eef6] mt-1 whitespace-pre-wrap break-words">
