...
export function PAvatar({ src, name, size = 40, className, verified }: PAvatarProps) {
  ...
  return (
    <div className="relative inline-flex shrink-0">
      {src ? (
        <div
          className={cn('rounded-full overflow-hidden bg-[#1a1a1a]', className)}
        ...
        <div
          className={cn(
            'rounded-full bg-gradient-to-br from-[#a3d977] to-[#6ba84a] flex items-center justify-center text-black font-bold shrink-0',
            className
          )}
      ...
      {verified && (
        <div
          className="absolute -bottom-0.5 -right-0.5 rounded-full bg-black flex items-center justify-center"
